...
//#else
NSString *const MJRefreshBundleName = @"Frameworks/LinCore.framework/MJRefresh.bundle";
//#endif
...
NSString *const MJRefreshFooterRefreshing = @"正在加载更多数据，请稍等...";
...
NSString *const MJRefreshHeaderRefreshing = @"正在重新加载数据，请稍等...";
