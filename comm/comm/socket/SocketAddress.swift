...
//        return aiptr?.pointee // copies the address to the return value
        return ai_addr.withMemoryRebound(to: T.self, capacity: 1) { (aiptr) -> T? in
...
//            return aiptr?.pointee // copies the address to the return value
            return ai_addr.withMemoryRebound(to: sockaddr_in.self, capacity: 1) { (aiptr) -> sockaddr_in? in
                return aiptr.pointee;
            }
        }
...
//            return aiptr?.pointee // copies the address to the return value
            return ai_addr.withMemoryRebound(to: sockaddr_in6.self, capacity: 1) { (aiptr) -> sockaddr_in6? in
                return aiptr.pointee;
            }
        }
