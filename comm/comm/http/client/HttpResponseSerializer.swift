...
public protocol HttpResponseSerializer {
    ...
    func responseObjectFromResponse(_ response: URLResponse, data: Data) -> (object: AnyObject?, error: NSError?)
}
...
//    */
//    public func responseObjectFromResponse(_ response: URLResponse, data: Data) -> (object: AnyObject?, error: NSError?) {
//        var error: NSError?
//        let response: AnyObject?
//        do {
//            response = try JSONSerialization.jsonObject(with: data, options: JSONSerialization.ReadingOptions())
